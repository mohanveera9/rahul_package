            ...
            <div className="flex flex-col md:flex-row items-center justify-between px-6 md:px-12 lg:px-20 pt-28 md:pt-32 pb-16 lg:py-32">
                ...
                <div className="text-center md:text-left">
                    ...
                    <p className="text-gray-700 mt-3 max-w-lg">
                        At <span className="font-semibold">Rahul Packaging</span>, we are committed to delivering 
                        high-quality packaging solutions that redefine excellence in the industry. 
                        Our innovation-driven approach ensures the best packaging for pharmaceuticals, food, 
                        and more.
                    </p>
                </div>
